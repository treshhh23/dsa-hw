...
public class ModelCode_AutoTracer {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // Program Loop
        do {
            // CLEAR SCREEN : This is the ANSI way in Java, but still need validations on
            // different OSes
            System.out.print("\033[H\033[2J"); // need to test on Mac and Linux.
            System.out.flush(); // Watch out for M silicon platform.

            // RUN LOGIC
            // Tracer makes path finding at Start (S) : Lab 4 / Every Intersection (I) : Lab
            // 5
...
// all intersections are considered nodes, identified by their Tile coordinate
// (x,y)
//
...
//
// plot the path on the map using '.', but do not plot over any tiles except ' '
// (empty paths)
//
