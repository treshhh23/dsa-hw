...
public class TileMap {
    ...
    public TileMap(int complexity) {
        ...
        // Step 2: Seed the Board with Initial Intersections based on the required
        // Complexity
    ...
    private Tile[] generateIntersections(int intCount) {
        ...
        while (count < intCount) {
            ...
            if (skipFlag)
                continue; // duplicated, try another candidate
    ...
    public Tile getGoalTile() {
        return map[BOARDSIZEY - 2][BOARDSIZEX - 2];
    }
}
